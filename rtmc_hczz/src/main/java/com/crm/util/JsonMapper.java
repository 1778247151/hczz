...
public class JsonMapper {
	   ...
	   */
	  public static Map<String, Object> getParamsMapByCondition(Map<String,Object> params, String condition){
...
//		    }
	  ...
	  /**
       * 
       * mapConvertJsonStr:将map转换为json字符串
       *
       * @author yumaochun
       * @date 2016年6月16日
       * @param map          需要转换的mapd对象
       * @return   返回：json字符串
       */
      public static String mapConvertJsonStr(Map<?,?> map){
          String jsonStr="";
          try {
              //map转换为json字符串
