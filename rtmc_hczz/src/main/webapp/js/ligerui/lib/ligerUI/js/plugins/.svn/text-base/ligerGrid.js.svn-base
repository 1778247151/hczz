...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        * @author  yumaochun
        */
        myChangeSort:function(columnName, sortOrder){
        	 var g = this, p = this.options;
...
//                g.loadData(p.where);
//            }
        	this.myChangeSort(columnName, sortOrder);
        },
        //改变分页
        ...
        _createHeaderCell: function (column)
        {
            ...
            if (column.ischeckbox)
            {
            	...
            	if(p.isSingleCheck){
                    ...
                    jcell.html("<div class='l-grid-hd-cell-inner'><div class='l-grid-hd-cell-text'></div></div>");
            	}else{
            		jcell.addClass("l-grid-hd-cell-checkbox");
                    jcell.html("<div class='l-grid-hd-cell-inner'><div class='l-grid-hd-cell-text '></div></div>");
            	}
