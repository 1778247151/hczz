...
columns = [
       	...
       	{ display: '物品编号', 			name: 'code', 			align: 'center',		width: "10%" },
       	{ display: '物品名称', 		name: 'name', 			align: 'center',		width: "5%" },
      
       	{ display: '兑换积分', 		name: 'exchangeIntegral', 			align: 'center',		width: "6%" },
       	{ display: '采购成本', 		name: 'price', 			align: 'center',	width: "5%" },
    	{ display: '过期金额', 		name: 'overdueMoney', 			align: 'center',	width: "5%" },
       	{ display: '物品类别', 		name: 'typeName', 			align: 'center',	width: "5%" },
       	{ display: '生效日期', 		name: 'effectiveTime', 			align: 'center',	width: "8%" },
    	{ display: '失效日期', 		name: 'expiryTime', 			align: 'center',	width: "8%" },
    	{ display: '兑换数', 		name: 'exchangeNumber', 			align: 'center',	width: "5%" },
    	{ display: '是否外借', 		name: 'isBorrowedName', 			align: 'center',	width: "5%" },
    	{ display: '押金', 		    name: 'deposit', 			align: 'center',	width: "5%" },
    	{ display: '一次费用', 		    name: 'cost', 			align: 'center',	width: "5%" },
    	/*{ display: '物品数量', 		    name: 'goodsNumber', 			align: 'center',	width: "5%" },*/
    	{ display: '外借时间(小时)', 		name: 'borrowedHouse', 			align: 'center',	width: "7%" },
    	{ display: '备注', 		name: 'description', 			align: 'center',	width: "16%" },
    	{ display: '物品图片地址', 		name: 'goodsImage', 			align: 'center',	width: "10%" },
...
$(function (){	
	...
	//创建数据列表
	dataUrl = baseUrl + "gwGoods/getGoodsByPageList.do";
...
if(_flag){
	...
	$.ligerDialog.open({ width:760, height: 520, url: url, isResize: false, title: "修改物品信息"});
}

}
//添加物品信息
function addGoods(){
var url="/manager/gw_goods/gw_goods_add.html";
$.ligerDialog.open({ width:760, height: 560, url: url, isResize: false, title: "添加物品信息"});
} 
...
var _flag = $.fsh.noteForNotSelected("请选中数据后，再操作！");
if(_flag) {
	var url = baseUrl + "gwGoods/deleteGoodsById.do?id=" +_flag.id+'&goodsCode='+_flag.code;
...
function getGoodsByCondition(){
	var form = new liger.get("form2");
 	...
 	var name = data.name;
 	var type = data.type;
	dataUrl = baseUrl+"gwGoods/getGoodsByPageList.do?code="+code+'&name='+name+'&type='+type
